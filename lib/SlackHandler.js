            ...
            case "deployment_success":               
                ...
                event.data.plan.steps.forEach(function (step) {
                    step.actions.forEach(function (action) {
                        ...
                        self.emit("found project name:", projectName);

                        self.emit("known projects:", JSON.stringify(self.projects));
...
SlackHandler.prototype.sendMessage = function (message) {
    ...
    let self = this;
    self.emit("num projects tagged for message:", message.projects.length);
